...
Cash flow tatements are divided into three sections: operating activities, investing activities, and financing activities.

You can filter the data by `ticker`, `period`, and `limit`.
